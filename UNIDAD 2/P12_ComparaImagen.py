...
qtCreatorFile = "P12_ComparaImagen.ui"  # Nombre del archivo aquí.
...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.lista_imagenes = [
            ":/meme/Imagen/sofi.png",
            ":/meme/Imagen/badillo .png",
            ":/meme/Imagen/JuarezBeltran.png",
            ":/meme/Imagen/GonzalezUriel.png"
        ]
